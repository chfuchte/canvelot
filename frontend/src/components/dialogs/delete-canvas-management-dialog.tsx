...
import { deleteCanvasMutationOptions } from "@/queries/management";
import { useManagementStore } from "@/stores/management";
import { useMutation } from "@tanstack/react-query";
import { useState } from "react";
import { toast } from "sonner";

export function DeleteCanvasManagementDialog({
    id,
    name,
    children,
}: {
    ...
    const removeCanvas = useManagementStore((state) => state.deleteCanvas);
